...
email_details = load_test_data("pc_financial")


@pytest.fixture
def parser() -> PCFinancialParser:
    return PCFinancialParser()
...
# Add a new test to verify all required fields are present in each JSON file

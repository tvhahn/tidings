...
> Source: Anthropic documentation — "Prompting Claude Fable 5". Saved verbatim as the canon for the `tune-fable-prompt` skill. Every snippet the skill inserts is pulled from this file.
